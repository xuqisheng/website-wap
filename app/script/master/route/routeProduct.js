...
define(function (require, exports, module) {
    ...
    Mobilebone.rootTransition = {
        proDetailsInto: function (pageInto, pageOut, callback) {
            base.ajax({
        ...
        proDetailsOut: function (pageInto, pageOut, callback) {
            Mobilebone.OUT && Mobilebone.OUT();
        },
        proRepaymentExplainInto: function (pageInto, pageOut, callback) {
        ...
        proRepaymentExplainOut: function (pageInto, pageOut, callback) {
            Mobilebone.OUT && Mobilebone.OUT();
        },
        porRewardInto: function (pageInto, pageOut, callback) {
        ...
        porRewardOut: function (pageInto, pageOut, callback) {
            Mobilebone.OUT && Mobilebone.OUT();
        },
        proInvestRecordInto: function (pageInto, pageOut, callback) {
        ...
        proInvestRecordOut: function (pageInto, pageOut, callback) {
            Mobilebone.OUT && Mobilebone.OUT();
        },
        proMoreInfoInto: function (pageInto, pageOut, callback) {
            base.ajax({
        ...
        proMoreInfoOut: function (pageInto, pageOut, callback) {
            Mobilebone.OUT && Mobilebone.OUT();
        },
        proPageSignInto: function (pageInto, pageOut, callback) {
            // 执行注册页面的js逻辑
        ...
        proPageSignOut: function (pageInto, pageOut, callback) {
            Mobilebone.OUT && Mobilebone.OUT();
        },
        proPageLoginInto: function (pageInto, pageOut, callback) {
            // 执行登录页面的js逻辑
            var userPhone = oneSession.get('userPhone');
        ...
        proPageLoginOut: function (pageInto, pageOut, callback) {
            Mobilebone.OUT && Mobilebone.OUT();
        }

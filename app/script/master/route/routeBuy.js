        ...
        proBuyInto: function (pageInto, pageOut, callback) {
            ...
            base.ajax({
                ...
                success: function (data) {
                    ...
                    if(data.resultData.cashRedpacketList == false){
                        $('#envelopeBtn #redPacketLimit').html('现金红包(无)').addClass('tits-one').next().hide();
                    }else{
                        globalData.cashRedpacketList = data.resultData.cashRedpacketList;
                    }
                    if(data.resultData.deductRedpacketList == false){
                        $('.clsbtn').html('抵扣红包(无)').addClass('tits-one').next().hide();
                    }else{
                        globalData.deductRedpacketList = data.resultData.deductRedpacketList;
                    }

<article class="viewport{{#equal tenderdetail.borrowStatus 8}} finished{{else}} unfinish{{/equal}}">
    ...
    <main class="cont">
        <ul class="ui-list-single">
            ...
            <li>
                <div class="column-left">到期收益（元）</div>
                <div class="column-right"><span class="font-color-red">{{toFixed tenderdetail.endInterest 2}}</span></div>
            </li>
            ...
            {{/if}}
            <li>
                <div class="column-left">到期时间</div>

{{#with product}}
    <article class="viewport">
        ...
        <div class="caution-bar">
            <a href="https://www.qian360.com/api/user/noticeDetail.html?noticeId=636"><span>钱宝宝已于5月25日停止转入，转入的会自动到余额。将于6月25日全面停止运营，点击查看具体退出计划</span><span>钱宝宝已于5月25日停止转入，转入的会自动到余额。将于6月25日全面停止运营，点击查看具体退出计划</span></a>
        </div>
        <div class="income-con nolink">
            <div class="income">
                ...
                <div class="cont">
                    <div class="import">
                        <div class="row"><input class="amount ui-input-text" id="amount" type="tel"
                                                placeholder="投入10000" pattern="[0-9]*"/><input
                                class="days ui-input-text" id="days" type="tel" placeholder="放365天"
                                pattern="[0-9]*"/></div>
        ...
        <div class="info-con">
            <div class="box">
                <a href="https://www.qian360.com/api/trade/projectDetail.html?borrowId={{borrowId}}">

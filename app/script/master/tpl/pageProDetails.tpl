    ...
    <article class="viewport">
        <div class="top-card">
            <div class="main">
                ...
                <div class="rule">期限{{#equal advanceRepayFlag 8}}{{previousBorrowDay}}天{{else}}{{#if isday}}{{timeLimitDay}}天{{else}}{{timeLimit}}月{{/if}}{{/equal}}<span class="divide"></span>{{lowestAccount}}元起投</div>
            </div>
            {{#if isAdvanceRepay}}
        ...
        <div class="income-con">
            <div class="explain">
                <ul>
                    ...
                    {{else}}
                        {{#equal style 1}}
                            <li>投资日计息，等额本息<i class="iconfont green">&#xe62e;</i></li>
                        {{else}}

...
define(function (require, exports, module) {
                ...
                "cashRedpacketList|5" :[
                    {
                        "leastTenderAmount":0,
                        "leastTenderDays":0,
                        "productTypeLimit|1":['聚宝盆','摇钱树','','小金库'],
                        "redPacketAmount":10,
                        "redpacketName":"测试内容6u1n",
                        "redpacketType":84827,
                        "useCondition":"测试内容82m2",
                        "validDate":31043,
                        "redpacketId|1-9":1

                    }
                ],
                "deductRedpacketList|5":[
                    {
                        "leastTenderAmount|0-3000":1,
                        "leastTenderDays|1-30":1,
                        "productTypeLimit|1":['聚宝盆','摇钱树','','小金库'],
                        "redPacketAmount":10,
                        "redpacketName":"测试内容6u1n",
                        "redpacketType":84827,
    ...
    //投资结果页
    Mock.mock(pageUrl.getCdKeys.url, {
        "resultCode": 1,
        "resultData": {
            cdKey:'123123aa'
        }
    ...
    Mock.mock(pageUrl.redPacket.url, {
        ...
        "resultData": {
            ...
            "list|5": [{
                ...
                "redpacketName|1":["现金红包","抵扣红包"],
                "overdueFlag|1":[true,false],
                "useCondition":'满2000使用\n啊速地方啊速'
    ...
    //任务中心
    Mock.mock(pageUrl.taskCenter.url, {
        "resultCode|0-1": 1,
        "resultData": {
            "invt_auth|0-1": 1,
            "invt_inv|0-1": 1,

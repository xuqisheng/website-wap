define(function (require, exports, module) {
    ...
    if (location.hostname == 'h5.qian360.com') {
        registerHref = location.protocol + '//www.qian360.com/promotion/index.html?code=liuliangbao'

    } else if (location.hostname == 'h5.test.qian360.com') {
        registerHref = location.protocol + '//test.qian360.com/promotion/index.html?code=liuliangbao'

    } else if (location.hostname == 'h5.test2.qian360.com') {
        registerHref = location.protocol + '//test2.qian360.com/promotion/index.html?code=liuliangbao'

    } else if (location.hostname == 'h5.test3.qian360.com') {
        registerHref = location.protocol + '//test3.qian360.com/promotion/index.html?code=liuliangbao'
    }

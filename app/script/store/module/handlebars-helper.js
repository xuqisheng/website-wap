 ...
 * 钱庄网
 * @name 基础js
 * @description handlebars的基础helper封装
 * @date 2015-12-15
 * @version $V1.0$
 */
    ...
    if (typeof define === 'function' && (define.amd || define.cmd)) {
        define(function (require, exports, module) {
            var Handlebars = require("handlebars"),
                dateFormat = require("qianModule/date-format");
            return factory(root, Handlebars, dateFormat);
        });
    } else {
        root.elperBase = factory(root, Handlebars, dateFormat);
    }
})(this, function (root, Handlebars, dateFormat) {
